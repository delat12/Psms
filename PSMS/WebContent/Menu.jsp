...
<%@ page import="java.text.*,java.util.*" session="true"%>
    <header class="mdl-layout__header">
    	...
    	<a class= "mdl-navigation__link" href="StuffForm.jsp">Add new stuff</a>
    	<a class= "mdl-navigation__link" href="StuffController?op=list">List new stuff</a>
        ...
        <a class ="mdl-navigation__link" href="StuffController?op=delete&opp=<c:out value='${product.id}' />">Add new stuff</a>
